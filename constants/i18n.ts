...
export const translations = {
  en: {
    ...
    home: {
      subtitle: (n: number) =>
        n > 0 ? `${n} item${n !== 1 ? "s" : ""} in history` : "Add your first media URL",
      filters: { all: "All", video: "Video", audio: "Audio", image: "Image", docs: "Docs" },
      empty: {
        title: "No Media Added",
        desc: "Add a URL to start playing videos, audio, images, PDFs, and more",
        btn: "Add Media URL",
      },
      noItems: (f: string) => `No ${f.toLowerCase()} items yet`,
    },
    history: {
      title: "History",
      subtitle: (n: number) =>
        n > 0 ? `${n} played item${n !== 1 ? "s" : ""}` : "No history yet",
      clear: "Clear",
      clearTitle: "Clear History",
      clearMsg: "Remove all history items?",
      empty: { title: "No History", desc: "Your playback history will appear here" },
    },
    favorites: {
      title: "Favorites",
      subtitle: (n: number) =>
        n > 0 ? `${n} saved item${n !== 1 ? "s" : ""}` : "Save your favorite media",
    ...
    modal: {
      ...
      userAgentHint: "Override HTTP User-Agent for restricted streams",
    ...
    player: {
      ...
      subtitleUrlPlaceholder: "https://example.com/subtitles.srt",
      subtitleFile: "Pick Local File",
      subtitleLoad: "Load",
      subtitleCancel: "Cancel",
      subtitleError: "Could not load subtitle file",
      ...
      permMsg: "Please allow access to save media to your library.",
    },
    card: {
      justNow: "Just now",
      ...
      remove: "Remove",
      removeMsg: "Remove this item from history?",
      cancel: "Cancel",
    },
    cancel: "Cancel",
    clearAll: "Clear All",
  ...
  ar: {
    ...
    home: {
      subtitle: (n: number) =>
        n > 0 ? `${n} ${n === 1 ? "عنصر" : "عناصر"} في السجل` : "أضف أول رابط وسائط",
      filters: { all: "الكل", video: "فيديو", audio: "صوت", image: "صور", docs: "مستندات" },
      empty: {
        title: "لا توجد وسائط",
        desc: "أضف رابطاً لتشغيل الفيديو والصوت والصور وملفات PDF والمزيد",
        btn: "إضافة رابط وسائط",
      },
      noItems: (f: string) => `لا توجد ${f} بعد`,
    },
    history: {
      title: "السجل",
      subtitle: (n: number) =>
        n > 0 ? `${n} ${n === 1 ? "عنصر" : "عناصر"} مُشغَّل` : "لا يوجد سجل",
      clear: "مسح",
      clearTitle: "مسح السجل",
      clearMsg: "هل تريد إزالة جميع عناصر السجل؟",
      empty: { title: "لا يوجد سجل", desc: "سيظهر سجل التشغيل هنا" },
    },
    favorites: {
      title: "المفضلة",
      subtitle: (n: number) =>
        n > 0 ? `${n} ${n === 1 ? "عنصر" : "عناصر"} محفوظ` : "احفظ وسائطك المفضلة",
    ...
    modal: {
      ...
      userAgentLabel: "User-Agent",
      userAgentPlaceholder: "User-Agent مخصص",
      userAgentHint: "تجاوز رأس HTTP User-Agent للبث المقيد",
    ...
    player: {
      subtitle: "ترجمة",
      subtitleNone: "بدون",
      subtitleUrl: "رابط الترجمة",
      subtitleUrlPlaceholder: "https://example.com/subtitles.srt",
      subtitleFile: "اختر ملفاً محلياً",
      subtitleLoad: "تحميل",
      subtitleCancel: "إلغاء",
      subtitleError: "تعذر تحميل ملف الترجمة",
      ...
      permMsg: "يرجى السماح بالوصول لحفظ الوسائط في مكتبتك.",
    },
    card: {
      justNow: "الآن",
      minutesAgo: (m: number) => `منذ ${m} دقيقة`,
      hoursAgo: (h: number) => `منذ ${h} ساعة`,
      daysAgo: (d: number) => `منذ ${d} يوم`,
      remove: "إزالة",
      removeMsg: "هل تريد إزالة هذا العنصر من السجل؟",
      cancel: "إلغاء",
    },
    cancel: "إلغاء",
    clearAll: "مسح الكل",
